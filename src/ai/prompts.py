...
- All *_zh fields MUST be written in Traditional Chinese (繁體中文，使用台灣慣用詞彙). 絕對不能使用簡體字，也不能用英文寫 _zh 欄位的內容。Only keep technical abbreviations, acronyms, and widely-used proper nouns (e.g. "GPT-4", "CUDA", "Rust") in their original English form; everything else must be Traditional Chinese.
...
Respond with valid JSON only. Each _en field must be in English; each _zh field MUST be in Traditional Chinese (繁體中文，台灣慣用詞彙). Every field MUST be at least one complete sentence (except community_discussion fields when no comments exist):
{{
  "title_en": "<short headline in English, ≤15 words>",
  "title_zh": "<用繁體中文寫一个简短标题，不超过15个词>",
  "whats_new_en": "<1-2 sentences in English>",
  "whats_new_zh": "<用繁體中文寫1-2句话>",
  "why_it_matters_en": "<1-2 sentences in English>",
  "why_it_matters_zh": "<用繁體中文寫1-2句话>",
  "key_details_en": "<1-2 sentences in English>",
  "key_details_zh": "<用繁體中文寫1-2句话>",
  "background_en": "<2-4 sentences in English, or empty string>",
  "background_zh": "<用繁體中文寫2-4句话，或空字符串>",
  "community_discussion_en": "<1-3 sentences in English, or empty string>",
  "community_discussion_zh": "<用繁體中文寫1-3句话，或空字符串>",
